...
class Profile {
  ...
  Profile({required this.name, required this.breed, required this.imagePath, required this.sex});
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _uploadProfile(Profile profile) async {
    DatabaseReference myRef = FirebaseDatabase.instance.ref().child("test/profiles/${profile.name}");
  ...
  Future<List<Profile>> getAllProfiles() async{
    ...
    final profiles = (dataFromDb.snapshot.value as Map<dynamic, dynamic>).entries
